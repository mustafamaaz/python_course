...
# searching is fast in dist if we want to search specific element dist is search quick but in list it take a time 
...
# Should print ['Yorkie', 'Collie', 'Bulldog']  0  is default if dog is not present then 0 
